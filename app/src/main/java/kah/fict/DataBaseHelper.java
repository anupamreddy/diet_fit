...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(CREATE_WORK_TABLE);
    }
    @Override
    ...
    public void addWork(String work,int time,int calories,String date)
    {
    ...
    */
     ...
     */
    /*
    public int burnedCalories(String date){
        SQLiteDatabase db= this.getReadableDatabase();
        Cursor cursor1 = db.query(TABLE_WORK, new String[]{KEY_WORK,KEY_TIME,KEY_CALORIES,KEY_DATE},
                KEY_DATE+ " =?",
                new String[]{String.valueOf(date)}, null,null,null,null);

        if (cursor1!=null) //If the cursor found the entry move to the first instance
            cursor1.moveToFirst();
        if(cursor1 == null)
            return 0;
